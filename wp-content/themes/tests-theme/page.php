						...
						<main id="main" class="m-all t-2of3 d-5of7 cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<section class="entry-content cf" itemprop="articleBody">
									...
									echo get_post_meta($post->ID, 'campo_um', true);
									echo "<br>";
									echo get_post_meta($post->ID, 'campo_dois', true);
									echo "<br>";
									echo get_post_meta($post->ID, 'demo_select', true);
									echo "<br>";
									echo get_post_meta($post->ID, 'demo_colorpicker', true);
									echo "<br>";
									echo do_shortcode(wpautop(get_post_meta($post->ID, 'demo_select', true)));
									...
									foreach ($image_ids as $image)
										{
										  ...
										  echo 'Titulo da Imagem: ' . $title . '<br>';
										  echo 'Descrição: ' . $description . '<br>';
										  echo 'Legenda: ' . $caption . '<br>';
